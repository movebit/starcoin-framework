...
module OnChainConfigScripts {
    ...
    public (script) fun propose_update_consensus_config(
        account: signer,
    ...
    public (script) fun propose_update_reward_config(
        account: signer,
        reward_delay: u64,
        exec_delay: u64,
    ) {
    ...
    public (script) fun propose_update_txn_publish_option(
        account: signer,
        script_allowed: bool,
    ...
    public (script) fun propose_update_txn_timeout_config(
        account: signer,
    ...
    public (script) fun propose_update_vm_config(
        account: signer,
        ...
        let vm_config = VMConfig::new_vm_config(
